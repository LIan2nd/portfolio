          ...
          <div className="flex flex-wrap items-center gap-2 mt-3">
            {entry.link && (
              <a
                ...
                aria-label={`${entry.link.label} (opens in new tab)`}
              ...
              >
                <ExternalLink aria-hidden="true" size={12} className="shrink-0 text-accent group-hover:text-white transition-colors duration-200" />
            ...
            {entry.certificate && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label={`${entry.certificate.label || "Certificate"} (opens in new tab)`}
                className="group inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-semibold bg-[var(--color-bg-secondary)] hover:bg-accent text-[var(--color-text-primary)] hover:text-white border border-[var(--color-bg-tertiary)] hover:border-accent transition-all duration-200 active:scale-95 shadow-xs no-underline"
              >
                <FileText aria-hidden="true" size={12} className="shrink-0 text-accent group-hover:text-white transition-colors duration-200" />
